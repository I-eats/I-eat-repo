...
async function fixCurrentClassStudents() {
  console.log('🔧 Fixing Current Class Students...')
  console.log('=====================================')
  ...
  try {
    ...
    if (!classes || classes.length === 0) {
      console.log('❌ No class found with code T2TEST')
      return
    }
    ...
    console.log('👥 Fetching students in current class...')
    ...
    if (!students || students.length === 0) {
      console.log('ℹ️  No students found in the current class')
      return
    }

    console.log(`✅ Found ${students.length} students in current class`)
